...
const MAX_ST_HT_ANGLE = 15;
const MIN_HTX = 225;
const MAX_HTX = 825;
const MIN_HTY = 105;
const MAX_HTY = 640; // (accounting for upper cone standoff as well)
const MIN_HT_LENGTH_LARGEST = 17.5; // minimum ht length for the largest reasonable ht diameter
const HT_CONE_RANGE = 15; // y difference from smallest to largest reasonable ht diameter
const MIN_DAX = 55;
const MAX_DAX = 830;
const MIN_DAY = -30;
const MAX_DAY = 320;
